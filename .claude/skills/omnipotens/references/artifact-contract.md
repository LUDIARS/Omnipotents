...
- Keep both `beginner` and `highResolution` prose inside the integrated executive summary, and switch the overall assessment and every direction together. Keep layer documents as one technical raw-data source below the explicit boundary.
