...
1. Read [references/artifact-contract.md](references/artifact-contract.md) and [references/vitia-ux-integration.md](references/vitia-ux-integration.md). When the run selects a `service.*` option or needs scope reduction, also read [references/service-analysis.md](references/service-analysis.md).
